                ...
                // get
                    ...
                    if (transfer_fin) {
                        ...
                        if (fd == -1) {
                            ...
                            transfer_th = transfer(c, fd, data_sock, curr_mode==BINARY ? simple_read : read_i2a, &transfer_fin);
                        }
                    } else {
                ...
                // put
                    ...
                    if (transfer_fin) {
                        ...
                        if (fd == -1) {
                            ...
                            transfer_th = transfer(c, data_sock, fd, curr_mode==BINARY ? simple_read : read_a2i, &transfer_fin);
                        }
                    } else {
                        server_say(c, 450, "Another transfer in progress");
                    }
